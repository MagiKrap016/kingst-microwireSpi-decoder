        ...
        mShowMarker(BIT_HIGH)
{
    ...
    mBitsPerTransferInterface->AddNumber(8, "Org 8", "");
    mBitsPerTransferInterface->AddNumber(16, "Org 16", "");
    ...
    mDataValidEdgeInterface->AddNumber(AnalyzerEnums::Level, "Data is Valid on Clock Level", "CPHA = 2 (Clock Level)");
